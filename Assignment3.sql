                                    ...
                                    --ASSIGNMENT NO.1 : Oracle Create Index--
...
FROM 
    TABLE(DBMS_XPLAN.DISPLAY());
                                    ...
                                    --ASSIGNMENT NO.2 : Oracle UNIQUE Index--
...
--GIVES ERROR BEACAUSE COMBINATION OF A AND B COLUMN VALUES TRY TO CREATE DUPLICATE VALUE
INSERT INTO unq_idx_demo(a,b)
VALUES(1,1);
...
--WE CAN ALSO PROVIDE A CUSTOMIZED NAME TO PRIMARY KEY INDEX
CREATE TABLE t2(
    pk2 INT PRIMARY KEY
        USING INDEX(
...
WHERE
    table_name='T2';
                                    ...
                                    --ASSIGNMENT NO.3 : Oracle Function-based Index--
...
FROM 
    TABLE(DBMS_XPLAN.DISPLAY());
                                    ...
                                    --ASSIGNMENT NO.4 : Oracle Bitmap Index--
...
CREATE BITMAP INDEX membaers_gender_i
ON members(gender);
...
--TO FIND THE CARDINALITY OF COLUMN
SELECT gender, COUNT(*)
FROM members
GROUP BY gender;
...
VALUES(0);
                                    ...
                                    --ASSIGNMENT NO.5 : Oracle FETCH--
                                    
                    
                -- SAMPLE DATABASAE CREATION               
...
--We can also Use Percentage in FETCH
SELECT
    product_name,
    quantity
FROM
